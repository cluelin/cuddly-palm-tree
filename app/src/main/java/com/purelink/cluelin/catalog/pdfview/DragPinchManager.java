 ...
 */
package com.purelink.cluelin.catalog.pdfview;

import android.graphics.PointF;

import com.purelink.cluelin.catalog.pdfview.util.DragPinchListener;
import com.purelink.cluelin.catalog.pdfview.util.DragPinchListener.OnDoubleTapListener;
import com.purelink.cluelin.catalog.pdfview.util.DragPinchListener.OnDragListener;
import com.purelink.cluelin.catalog.pdfview.util.DragPinchListener.OnPinchListener;

import static com.purelink.cluelin.catalog.pdfview.util.Constants.Pinch.*;
import static com.purelink.cluelin.catalog.pdfview.util.Constants.Pinch.MAXIMUM_ZOOM;
import static com.purelink.cluelin.catalog.pdfview.util.Constants.Pinch.MINIMUM_ZOOM;
import static com.purelink.cluelin.catalog.pdfview.util.Constants.Pinch.QUICK_MOVE_THRESHOLD_DISTANCE;
import static com.purelink.cluelin.catalog.pdfview.util.Constants.Pinch.QUICK_MOVE_THRESHOLD_TIME;
